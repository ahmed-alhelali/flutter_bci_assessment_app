...
class PaginatedDataTable extends ConsumerStatefulWidget {
  ...
  PaginatedDataTable({
    ...
    this.primary,
      ...
      : assert(actions == null || (header != null)),
        ...
        assert(dataRowMinHeight == null || dataRowMaxHeight == null ||
...
class PaginatedDataTableState extends ConsumerState<PaginatedDataTable> {
  ...
  DataRow _getBlankRowFor(int index) {
    return DataRow.byIndex(
      index: index,
      cells: widget.columns.map<DataCell>((DataColumn column) => DataCell.empty)
          .toList(),
    );
  }
              ...
              if (headerWidgets.isNotEmpty)
                Semantics(
                  ...
                  child: DefaultTextStyle(
                    ...
                    style: _selectedRowCount > 0 ? themeData.textTheme
                    ...
                    child: IconTheme.merge(
                      ...
                      child: Ink(
                        height: 64.0,
                        color: _selectedRowCount > 0 ? themeData
